! function (t, e) {
    ...
    var A, P = function (t) {
        ...
        rt = function (t) {
            var e;
            if ((e = I()) && (e.parentNode.removeChild(e), O([document.documentElement, document.body], [x["no-backdrop"], x["toast-shown"], x["has-column"]])), nt()) k("SweetAlert2 requires document to initialize");
            else {
        ...
        ut = function (t) {
            ...
            t.html ? (at(t.html, e), V(e, "block")) : t.text ? (e.textContent = t.text, V(e, "block")) : q(e),
                function (e) {
        ...
        pt = function (i) {
            var r = K(),
                a = parseInt(null === i.currentProgressStep ? Ut.getQueueStep() : i.currentProgressStep, 10);
        ...
        mt = function (t) {
            var e, n, o, i;
            e = t, n = D(), M(n, "width", e.width), M(n, "padding", e.padding), e.background && (n.style.background = e.background), n.className = x.popup, e.toast ? (E([document.documentElement, document.body], x["toast-shown"]), E(n, x.toast)) : E(n, x.modal), y(n, e.customClass, "popup"), "string" == typeof e.customClass && E(n, e.customClass), e.animation ? O(n, x.noanimation) : E(n, x.noanimation),
                function (t) {
                    var e = I();
                    if (e) {
    ...
    function Ot(t) {
        ...
        if (n) {
            ...
            var s = function () {
                ...
                }), vt.keydownHandlerAdded = !1), e.parentNode && e.parentNode.removeChild(e), O([document.documentElement, document.body], [x.shown, x["height-auto"], x["no-backdrop"], x["toast-shown"], x["toast-column"]]), tt() && (null !== v.previousBodyPadding && (document.body.style.paddingRight = v.previousBodyPadding + "px", v.previousBodyPadding = null), function () {
    ...
    var Rt, Nt = Object.freeze({
        ...
        setProgressSteps: function (t) {
            ...
            var e = s({}, xt.innerParams.get(this), {
                progressSteps: t
            });
        ...
        _main: function (t) {
            ...
            return new Promise(function (t) {
                ...
                if (vt.keydownHandlerAdded && (vt.keydownTarget.removeEventListener("keydown", vt.keydownHandler, {
                    capture: vt.keydownListenerCapture
                }), vt.keydownHandlerAdded = !1), f.toast || (vt.keydownHandler = function (t) {
                    return function (t, e) {
                        if (e.stopKeydownPropagation && t.stopPropagation(), "Enter" !== t.key || t.isComposing)
                            if ("Tab" === t.key) {
                                for (var n = t.target, o = G(e.focusCancel), i = -1, r = 0; r < o.length; r++)
                                    if (n === o[r]) {
                                        i = r;
                                        break
                ...
                }, vt.keydownTarget = f.keydownListenerCapture ? window : m.popup, vt.keydownListenerCapture = f.keydownListenerCapture, vt.keydownTarget.addEventListener("keydown", vt.keydownHandler, {
                    capture: vt.keydownListenerCapture
                }), vt.keydownHandlerAdded = !0), p.enableButtons(), p.hideLoading(), p.resetValidationMessage(), f.toast && (f.input || f.footer || f.showCloseButton) ? E(document.body, x["toast-column"]) : O(document.body, x["toast-column"]), "select" === f.input || "radio" === f.input) {
                    var u = z(),
                        l = function (t) {
