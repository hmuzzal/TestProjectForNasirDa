...
!function($) {
    ...
    CalendarApp.prototype.onSelect = function (start, end, allDay) {
        var $this = this;
            ...
            $this.$modal.find('form').on('submit', function () {
                ...
                var url = '../../Home/AddEvents';
                var data1 = { "date": String(start), "title": title };
    ...
    CalendarApp.prototype.init = function() {
        ...
        const incomeUrl = '../../Home/AllEvents';
        ...
        fetch(incomeUrl)
            ...
            .then(incomeData => {
                ...
                for (var i = 0; i < incomeData.length; i++) {
                    const date = new Date(incomeData[i].Value);
                    var datevalue = date.getTime();
                    console.log(datevalue);

                    var singe = {
                        title: incomeData[i].Text,
                        start: new Date(datevalue),
                        className: 'bg-info'
                    }
                    defaultEvents.push(singe);
                }
