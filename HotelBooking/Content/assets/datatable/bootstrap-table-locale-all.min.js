...
! function (a) {
    ...
    function (a) {
        ...
        a.fn.bootstrapTable.locales["de-DE"] = {
            ...
            formatShowingRows: function (a, b, c) {
                return "Zeige Zeile " + a + " bis " + b + " von " + c + " Zeilen" + (c > 1 ? "n" : "") + "."
            },
    ...
    function (a) {
        ...
        a.fn.bootstrapTable.locales["et-EE"] = {
            ...
            formatShowingRows: function (a, b, c) {
                return "Näitan tulemusi " + a + " kuni " + b + " - kokku " + c + " tulemust"
            },
            formatSearch: function () {
                return "Otsi"
            },
    ...
    function (a) {
        ...
        a.fn.bootstrapTable.locales["fr-FR"] = {
            ...
            formatShowingRows: function (a, b, c) {
                return "Affichage des lignes " + a + " à " + b + " sur " + c + " lignes au total"
            },
            formatSearch: function () {
                return "Rechercher"
            },
    ...
    function (a) {
        ...
        a.fn.bootstrapTable.locales["it-IT"] = {
            ...
            formatShowingRows: function (a, b, c) {
                return "Elementi mostrati da " + a + " a " + b + " (Numero totali di elementi " + c 
            },
            formatSearch: function () {
                return "Cerca"
            },
    ...
    function (a) {
        ...
        a.fn.bootstrapTable.locales["nl-NL"] = {
            ...
            formatShowingRows: function (a, b, c) {
                return "Toon " + a + " tot " + b + " van " + c + " record" + (c > 1 ? "s" : "")
            },
            formatDetailPagination: function (a) {
